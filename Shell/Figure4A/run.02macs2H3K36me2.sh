...
bamCompare -b1 ${inputPath}/${ipFile}.sorted.mkdup.rmblacklist.bam -b2 ${inputPath}/${controlFile}.sorted.mkdup.rmblacklist.bam --operation subtract \
           -o ${outputPath}/${outputName}.SubtractCPM.bw --centerReads --binSize 20 --scaleFactorsMethod None \
